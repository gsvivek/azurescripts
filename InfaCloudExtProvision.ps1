...
$pinfo.Arguments = '-jar C:\Program Files\Informatica Cloud Secure Agent\CloudExtProvisionClient.jar "cloudEmail" "$cloudEmail" "cloudPassword" "$cloudPassword" "connectorUUIDs" "$connectorUUIDs" "identifier" "$computerSystemProduct.UUID"'
